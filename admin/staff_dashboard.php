...
<body>
  <div class="main-container">
    ...
    <div class="top-bar">
        ...
        <h3>Popular this week <!--<a href="allnotices.html" style="float:right; font-size:14px">View all</a> --></h3>

    </div>
    <div class="popular-section" style="max-height: 80vh; overflow-y:auto;">
      
                  <?php
            require 'db.php'; // Ensure this file contains the $conn connection

            $sql = "SELECT title, meta, image_path FROM notices WHERE audience = 'staff' ORDER BY id DESC";
    ...
    <div id="notice-modal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100%; background:rgba(0,0,0,0.4); z-index:1000; align-items:center; justify-content:center; overflow:auto;  ">
      <div style="background:#fff; border-radius:12px; padding:24px; max-width:400px; height:90%; margin:auto; position:relative; overflow-y: auto;" >
